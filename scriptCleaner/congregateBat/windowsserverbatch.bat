...
choice /m "Disable FTP service (it might not be on the computer, but you can run this anyway)?"
if Errorlevel 2 goto NoDisableFTP
if Errorlevel 1 goto YesDisableFTP
:YesDisableFTP
